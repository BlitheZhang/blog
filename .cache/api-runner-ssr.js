var plugins = [{
      ...
      plugin: require('/Users/blithe/Desktop/blog/node_modules/gatsby-plugin-theme-ui/gatsby-ssr.js'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-sitemap',
      plugin: require('/Users/blithe/Desktop/blog/node_modules/gatsby-plugin-sitemap/gatsby-ssr.js'),
      ...
      plugin: require('/Users/blithe/Desktop/blog/node_modules/gatsby-plugin-manifest/gatsby-ssr.js'),
      ...
      plugin: require('/Users/blithe/Desktop/blog/node_modules/gatsby-plugin-feed/gatsby-ssr.js'),
      options: {"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                title: siteTitle\n                description: siteDescription\n                siteUrl\n                site_url: siteUrl\n              }\n            }\n          }\n        ","feeds":[{"query":"{\n  allPost(sort: {date: DESC}) {\n    nodes {\n      title\n      date(formatString: \"MMMM D, YYYY\")\n      excerpt\n      slug\n    }\n  }\n}","output":"rss.xml","title":"Minimal Blog - @lekoarts/gatsby-theme-minimal-blog"}]},
    },{
      name: 'partytown',
      plugin: require('/Users/blithe/Desktop/blog/node_modules/gatsby/dist/internal-plugins/partytown/gatsby-ssr.js'),
      options: {"plugins":[]},
    }]
/* global plugins */
